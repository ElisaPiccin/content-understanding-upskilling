...
def main():
    ...
    try:
        ...
        # default value
        image_file = '2025-05-01-preview/biz-card-1.png'
        # read the image file from command line argument if provided
        if len(sys.argv) > 1:
        ...
        print(f"Using endpoint: {ai_svc_endpoint}")
        print(f"Using analyzer: {analyzer}")
...
def analyze_card (image_file, analyzer, endpoint, key):
    ...
    if status == "Succeeded":
        ...
        output_file = "2025-05-01-preview/results-lab.json"
